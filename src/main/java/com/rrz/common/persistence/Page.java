 ...
 */
package com.rrz.common.persistence;
...
public class Page<T> {
   ...
   public void build(PageList pageList) {
        if (null != pageList) {
            setPageNo(pageList.getCurrentPage());
            setPageSize(pageList.getPageSize());
            setCount(pageList.getCount());
            setListArray(pageList.getEntities());
        }
    }
...
//	}
    ...
    public Page<T> setListArray(Collection<T> list) {
