...
import com.rrz.common.security.Digests;
import com.rrz.common.security.shiro.session.SessionDAO;
import com.rrz.common.service.BaseService;
import com.rrz.common.service.ServiceException;
import com.rrz.common.utils.CacheUtils;
import com.rrz.common.utils.Encodes;
import com.rrz.common.utils.StringUtils;
import com.rrz.common.web.Servlets;
import com.rrz.modules.sys.dao.MenuDao;
import com.rrz.modules.sys.dao.RoleDao;
import com.rrz.modules.sys.dao.UserDao;
import com.rrz.modules.sys.entity.Menu;
import com.rrz.modules.sys.entity.Office;
import com.rrz.modules.sys.entity.Role;
import com.rrz.modules.sys.entity.SysMaintenanceLog;
import com.rrz.modules.sys.entity.User;
import com.rrz.modules.sys.security.SystemAuthorizingRealm;
import com.rrz.modules.sys.utils.LogUtils;
...
//		systemRealm.clearAllCachedAuthorizationInfo();
	...
	public Page<Role> findAllRoleList(Page<Role> page,Role role){
		role.setPage(page);
		page.setList(UserUtils.getRoleList());
		return page;
	}
	...
	public void saveRole(Role role) {
		...
		// 更新角色与作品类型关联
/*		roleDao.deleteRoleArticleType(role);
		if (StringUtils.isNotEmpty(role.getRoleArtciletypeRelationship().getArticleType())){
			roleDao.insertRoleArticleType(role);
		}*/
...
//		systemRealm.clearAllCachedAuthorizationInfo();
	...
	public static boolean printKeyLoadMessage(){
		...
		sb.append("\r\n======================================================================\r\n");
		sb.append("\r\n    欢迎使用 "+Global.getConfig("productName")+"  - Powered By http://manage.yryz.com/yryzManage\r\n");
		sb.append("\r\n======================================================================\r\n");
...
//		}
	 ...
	 * @return
	 */
	public User getUserSingleByParams(User user){
		return userDao.getUserSingleByParams(user);
	}
