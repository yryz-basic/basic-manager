        ...
        e.extend(k.dialog, {
            ...
            file: function(u, v, w) {
                ...
                var y = function() {
                    ...
                    var z = b.isCustomDomain(),
                    A = ['<iframe name="uploadFrame" frameborder="0" allowtransparency="0" class="cke_dialog_ui_input_file" role="presentation" id="', x.frameId, '" title="', v.label, '" src="javascript:void('];
