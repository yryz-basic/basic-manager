	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			$(".resetPwd").click(function(){
				var finder = $(this).parent().parent().find("td");
				var id = finder.eq(0).text();
				var loginName = finder.eq(3).text();
				$.post("${ctx}/sys/user/updatePwd",{id:id,loginName:loginName,type:"1"},function(data){
					if(data==1){
						alert("重置账户"+loginName+"密码成功");
					}else{
						alert("重置账户"+loginName+"密码失败,请稍后再试!");
					}
				});
			});
