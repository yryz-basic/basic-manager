...
<head>
    ...
    <script type="text/javascript" src="${ctxStatic}/common/jquery.blockUI.js"></script>
	<style type="text/css">
		...
		<div id="header" class="navbar navbar-fixed-top">
			<div class="navbar-inner">
				...
				<ul id="userControl" class="nav pull-right">
					<li><a href="${pageContext.request.contextPath}/a" title="访问网站主页"><i class="icon-home"></i></a></li>
